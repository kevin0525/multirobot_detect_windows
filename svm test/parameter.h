//-----------------------宏定义----------------------------
//---------------------------------------------------------
#define IrobotSetNo 430			//机器人样本个数  
#define ObstacleSetNo 239		//障碍样本个数
#define BackgroundSetNo 412		//背景样本个数
#define HardBackgroundSetNo 253	//Hard背景样本个数
...
#define TestVideo "../Data/TestVideo/jade_s.avi"			//用于检测的测试视频
#define ResultVideo "../Data/Result/jade_s.avi"			//测试视频的检测结果
#define ResultVideoFile_1 "..\\Data\\Result\\out_1\\"	//测试视频的分类框图文件夹1
#define ResultVideoFile_2 "..\\Data\\Result\\out_2\\"	//测试视频的分类框图文件夹2
#define ResultVideoFile_3 "..\\Data\\Result\\out_3\\"	//测试视频的分类框图文件夹3
